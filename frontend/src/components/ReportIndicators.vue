<template>
  <div class="flex flex-wrap items-center gap-1.5">
    ...
    <!-- Analyse jdeps -->
    <span v-if="jdepsDependencies > 0" class="indicator" :title="jdepsDependencies + ' dépendances analysées (jdeps)'">
    ...
    <!-- Analyse Sonar -->
    <span v-if="sonarIssues !== null && sonarIssues !== undefined" class="indicator indicator-letter bg-cyan-100 text-cyan-700" :title="sonarIssues + ' issues Sonar'">
      S
    </span>

    <!-- Analyse OSS -->
    <span v-if="ossAnalyzed > 0" class="indicator" :title="ossAnalyzed + ' dépendances analysées (OSS Index)'">
